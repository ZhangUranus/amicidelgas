...
public abstract class EntityOperator extends EntityConditionBase {
    ...
    public static final EntityComparisonOperator IN = new EntityComparisonOperator(ID_IN, "IN") {
        ...
        protected void makeRHSWhereStringValue(ModelEntity entity, List entityConditionParams, StringBuffer sb, ModelField field, Object rhs, DatasourceInfo datasourceInfo) { appendRHSList(entityConditionParams, sb, field, rhs); }
    };
