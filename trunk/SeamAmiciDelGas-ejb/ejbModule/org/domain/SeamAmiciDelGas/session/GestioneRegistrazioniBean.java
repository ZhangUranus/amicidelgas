...
import org.domain.SeamAmiciDelGas.processes.RegistrationConfirmation;
...
public class GestioneRegistrazioniBean {
	...
	public List<Account> getRichiesteCustomer() {
		...
		accountList.setEjbql("select account from Account account where account.attivato=false and account.utente != null and account.elimato=false");
