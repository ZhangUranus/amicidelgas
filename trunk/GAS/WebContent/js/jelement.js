...
function show_infolevel(cond)
{
	...
	if (current_infolevel == 1) {
		...
		if(cond){
			document.getElementById('plus_img_infolevel').src = "/GAS/img/plus_off.png";
		} else {
			document.getElementById('plus_img_infolevel').src = "/GAS/img/plus.png";
		}
	} else {
		if(cond){
			document.getElementById('plus_img_infolevel').src = "/GAS/img/minus_off.png";
		} else {		
			document.getElementById('plus_img_infolevel').src = "/GAS/img/minus.png";
		}
	}
}
...
function docs()
{
	...
	if (current_docslevel == 0) {
		...
		document.getElementById('plus_img_docs').src = "/GAS/img/plus_off.jpg";
		current_docslevel = 1;
	} else {
		document.getElementById('idi_133760042').style.display = 'none';
		document.getElementById('plus_img_docs').src = "/GAS/img/minus_off.jpg";	
		current_docslevel = 0;
	}
}
...
function show_docs(cond)
{
	...
	if (current_docslevel == 1) {
		...
		if(cond){
			...
			document.getElementById('plus_img_docs').src = "/GAS/img/plus.jpg";
		}
	} else {
		if(cond){
			document.getElementById('plus_img_docs').src = "/GAS/img/minus_off.jpg";
		} else {		
			document.getElementById('plus_img_docs').src = "/GAS/img/minus.jpg";
		}
	}
}
...
function euro()
{
	...
	if (current_eurolevel == 0) {
		...
		document.getElementById('plus_img_euro').src = "/GAS/img/plus_off.jpg";
		current_eurolevel = 1;
	} else {
		document.getElementById('euro').style.display = 'none';
		document.getElementById('plus_img_euro').src = "/GAS/img/minus_off.jpg";	
		current_eurolevel = 0;
	}
}
...
function show_euro(cond)
{
	...
	if (current_eurolevel == 1) {
		...
		if(cond){
			...
			document.getElementById('plus_img_euro').src = "/GAS/img/plus.jpg";
		}
	} else {
		if(cond){
			document.getElementById('plus_img_euro').src = "/GAS/img/minus_off.jpg";
		} else {		
			document.getElementById('plus_img_euro').src = "/GAS/img/minus.jpg";
		}
	}
}
...
function wall()
{
	...
	if (current_walllevel == 0) {
		...
		document.getElementById('plus_img_wall').src = "/GAS/img/plus_off.jpg";
		current_walllevel = 1;
	} else {
		document.getElementById('wallpaper').style.display = 'none';
		document.getElementById('plus_img_wall').src = "/GAS/img/minus_off.jpg";	
		current_walllevel = 0;
	}
}
...
function show_wall(cond)
{
	...
	if (current_walllevel == 1) {
		...
		if(cond){
			...
			document.getElementById('plus_img_wall').src = "/GAS/img/plus.jpg";
		}
	} else {
		if(cond){
			document.getElementById('plus_img_wall').src = "/GAS/img/minus_off.jpg";
		} else {		
			document.getElementById('plus_img_wall').src = "/GAS/img/minus.jpg";
		}
	}
}
...
function dockplus()
{
	...
	if (current_dockplus == 0) {
		...
		document.getElementById('dock_img').src = "/GAS/img/down.png";
		current_dockplus = 1;
	} else {
		document.getElementById('dock_plus').style.display = 'none';
		document.getElementById('dock_img').src = "/GAS/img/up.png";	
		current_dockplus = 0;
	}
}
...
function calendar()
{
	...
	if (current_calendarlevel == 0) {
		...
		document.getElementById('plus_img_calendar').src = "/GAS/img/plus_off.jpg";
		current_calendarlevel = 1;
	} else {
		document.getElementById('idi_1547474924').style.display = 'none';
		document.getElementById('plus_img_calendar').src = "/GAS/img/minus_off.jpg";	
...
function show_calendar(cond)
{
	...
	if (current_calendarlevel == 1) {
		...
		if(cond){
			...
			document.getElementById('plus_img_calendar').src = "/GAS/img/plus.jpg";
		}
	} else {
		if(cond){
			document.getElementById('plus_img_calendar').src = "/GAS/img/minus_off.jpg";
		} else {		
			document.getElementById('plus_img_calendar').src = "/GAS/img/minus.jpg";
		}
	}
}
function groups()
{
	...
	if (current_groupslevel == 0) {
		...
		document.getElementById('plus_img_groups').src = "/GAS/img/plus_off.jpg";
		current_groupslevel = 1;
	} else {
		document.getElementById('1920ffgghh').style.display = 'none';
		document.getElementById('plus_img_groups').src = "/GAS/img/minus_off.jpg";	
...
function show_groups(cond)
{
	...
	if (current_groupslevel == 1) {
		...
		if(cond){
			...
			document.getElementById('plus_img_groups').src = "/GAS/img/plus.jpg";
		}
	} else {
		if(cond){
			document.getElementById('plus_img_groups').src = "/GAS/img/minus_off.jpg";
		} else {		
			document.getElementById('plus_img_groups').src = "/GAS/img/minus.jpg";
		}
	}
}